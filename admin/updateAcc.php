...
<body>
  ...
  if(isset($_GET['update_id']) && !empty($_GET['update_id'])){
    ...
    $stmt_edit = $DB_con->prepare('SELECT * FROM users WHERE user_id =:update_id');
...
$usernamea = $_POST['username'];
 $passworda = $_POST['password'];
    ...
    $query = "UPDATE `users` SET `username`='".$usernamea."',`password`='".$passworda."' WHERE `user_id` = $user_id";
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <label for="LRN" class="form-label">Password</label>
