...
<body>
  ...
  if(isset($_GET['update_id']) && !empty($_GET['update_id'])){
    ...
    $stmt_edit = $DB_con->prepare('SELECT * FROM patient WHERE id =:update_id');
...
$databasename = "med";
 ...
 $Patient_Noa = $_POST['Patient_No'];
$Namea = $_POST['Name'];
 $LRNa = $_POST['LRN'];
 $Datea = $_POST['Date'];
 

 $query = "UPDATE `patient` SET `Name`='".$Namea."',`LRN`='".$LRNa."',`Date`='".$Datea."' WHERE `id` = $id";
