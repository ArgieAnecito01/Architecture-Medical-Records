...
<section class="section">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>Appointment List<a href="https://github.com/fiduswriter/Simple-DataTables" target="_blank"></a>  <code></code></p>
      ...
      $stmt = $DB_con->prepare('SELECT * FROM appointment');
      $stmt->execute();
...
<td>
           ...
           <div class=function3>   <a class = "b3" href="delete_data2.php?delete_id=<?php echo $row['appointmentid']; ?>"onclick="return confirm('Are you sure to Delete?');">
          DELETE</a></div><br>
