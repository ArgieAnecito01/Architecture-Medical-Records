...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link collapsed" href="index.php" onclick="return confirm('Are you sure to logout?');">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3"action="medicine.php" method="post"> 
             
              <div class="col-md-6">
                  <label for="Name" class="form-label">Add Medicine</label>
                  <input type="text" class="form-control"name="i1">
                </div>
                <div class="col-md-6">
                  <label for="Name" class="form-label">Stocks</label>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>Medicine List<a href="https://github.com/fiduswriter/Simple-DataTables" target="_blank"></a>  <code></code></p>
      ...
      $stmt = $DB_con->prepare('SELECT * FROM medicine');
      $stmt->execute();
...
<td>
                ...
                <a  class = "b2" href="update.php?update_id=<?php echo $row['id']; ?>">UPDATE </a>
            <a class = "b3" href="delete.php?delete_id=<?php echo $row['id']; ?>"onclick="return confirm('Are you sure to Delete?');">
          DELETE</a><br>
...
if(isset($_POST['insert']))
{
 ...
 $pdoQuery = "INSERT INTO `medicine`(`medicine`, `Stocks`) VALUES (:i1,:i2)";
 $pdoResult = $pdoConnect->prepare($pdoQuery);
 $pdoExec = $pdoResult->execute(array(":i1"=>$medicine,":i2"=>$Stocks));
